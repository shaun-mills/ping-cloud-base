...
echo "Initial KARPENTER_ROLE_ANNOTATION_KEY_VALUE: ${KARPENTER_ANNOTATION_KEY_VALUE}"
...
# export KARPENTER_ROLE_ANNOTATION_KEY_VALUE=${KARPENTER_ANNOTATION_KEY_VALUE:-''}
...
echo "Using KARPENTER_ANNOTATION_KEY_VALUE: ${KARPENTER_ANNOTATION_KEY_VALUE}"
...
(
  ...
  # shellcheck disable=SC2016
  set_var "KARPENTER_ANNOTATION_KEY_VALUE" "" "${IRSA_BASE_PATH}" "karpenter-controller/arn" "${IRSA_TEMPLATE}"
  ...
  echo "Using IRSA_PING_ANNOTATION_KEY_VALUE: ${IRSA_PING_ANNOTATION_KEY_VALUE}"
  echo "Using IRSA_BOOTSTRAP_ANNOTATION_KEY_VALUE: ${IRSA_BOOTSTRAP_ANNOTATION_KEY_VALUE}"
  echo "Using KARPENTER_ROLE_ANNOTATION_KEY_VALUE: ${KARPENTER_ANNOTATION_KEY_VALUE}"
  echo "Using IRSA_INGRESS_ANNOTATION_KEY_VALUE: ${IRSA_INGRESS_ANNOTATION_KEY_VALUE}"
  echo "Using NLB_NGX_PUBLIC_ANNOTATION_KEY_VALUE: ${NLB_NGX_PUBLIC_ANNOTATION_KEY_VALUE}"
  echo "Using CLUSTER_ENDPOINT: ${CLUSTER_ENDPOINT}"
